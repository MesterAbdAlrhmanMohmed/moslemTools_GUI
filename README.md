...
 مثلاً ctrl+10 للانتقال إلى 10% من المقطع.
...
لحذف أي كتاب حديث تم تحميله في هذه التبويبة، نستخدم زر الحذف أو زر التطبيقات.

 في حالة تحميل كتاب جديد، لإعادة تحميل قائمة الكتب، نضغط على زر F5.
...
قارئ للقرآن: لتبويبة القرآن الكريم مكتوب، يقوم هذا القسم بتنزيل القرآن آية بآية.
