...
class QuranRange(QuranRangeActionsMixin, QuranRangeMergerSaverMixin, qt.QDialog):
    def __init__(self, p, index: int):
        ...
        self.combo_from_surah = guiTools.QComboBox()
        ...
        self.combo_to_surah = guiTools.QComboBox()
