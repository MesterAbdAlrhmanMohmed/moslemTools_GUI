...
class FromToSurahWidget(qt.QDialog):
    ...
    def onGo(self):
        ...
        menu.setFont(font)         
        readAction = qt1.QAction("قراءة (Ctrl+R)", self)
        ...
        translationAction = qt1.QAction("ترجمة (Ctrl+L)", self)
