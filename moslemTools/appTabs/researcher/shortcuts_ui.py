...
class ResearcherShortcutsUIMixin:
    ...
    def init_ui(self):
        ...
        self.ahadeeth = guiTools.QComboBox()
        ...
        self.ahadeeth_chapter = guiTools.QComboBox()
        ...
        self.surahs = guiTools.QComboBox()
        ...
        self.specific_scope_combo = guiTools.QComboBox()
        ...
        self.serch_input.setPlaceholderText("أكتب محتوى البحث")
