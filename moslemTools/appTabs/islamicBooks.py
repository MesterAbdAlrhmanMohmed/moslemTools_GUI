...
class IslamicBooks(qt.QWidget):
    def __init__(self):
        ...
        self.info2 = guiTools.QNavigableLabel("لخيارات الكتاب المحدد، نستخدم مفتاح التطبيقات أو click الأيمن")
        ...
        self.info1 = guiTools.QNavigableLabel("تنبيه هام , مطور البرنامج غير مسؤول عن محتوى هذه الكتب")
        ...
        self.info4 = guiTools.QNavigableLabel("يمكن استخدام زر الحذف delete لحذف الكتاب المحدد")
        self.info4.setFocusPolicy(qt2.Qt.FocusPolicy.StrongFocus)
        self.info4.setAlignment(qt2.Qt.AlignmentFlag.AlignCenter)
        self.info3 = guiTools.QNavigableLabel("يمكنكم تحميل المزيد من تحميل موارد إضافية من الإعدادات")
