...
class IslamicBooks(qt.QWidget):
    def __init__(self):
        ...
        self.info = qt.QLineEdit("في حالة تحميل كتاب جديد, يرجى إعادة تحميل قائمة الكتب بالضغط على زر F5")
        self.info.setReadOnly(True)
        self.info.setFocusPolicy(qt2.Qt.FocusPolicy.StrongFocus)
        self.info.setAlignment(qt2.Qt.AlignmentFlag.AlignCenter)
        self.info2 = qt.QLineEdit("لخيارات الكتاب المحدد، نستخدم مفتاح التطبيقات أو click الأيمن")
        ...
        right_layout.addWidget(self.info2)

        self.info1 = qt.QLineEdit("تنبيه هام , مطور البرنامج غير مسؤول عن محتوى هذه الكتب")
        ...
        self.info4 = qt.QLineEdit("يمكن استخدام زر الحذف delete لحذف الكتاب المحدد")
        ...
        self.info3 = qt.QLineEdit("يمكنكم تحميل المزيد من تحميل موارد إضافية من الإعدادات")
        ...
        left_layout.addWidget(self.info4)
        left_layout.addWidget(self.info3)

        bottom_layout.addLayout(right_layout, 1)
        bottom_layout.addSpacing(10)
        bottom_layout.addWidget(self.info1, 1)
        bottom_layout.addSpacing(10)
