...
class Athker(qt.QWidget):
    def __init__(self):
        ...
        self.info1 = qt.QLineEdit("لخيارات فئة الأذكار المحددة، نستخدم مفتاح التطبيقات أو click الأيمن")
        ...
        self.info2 = qt.QLineEdit("يمكنكم تحميل الأذكار الصوتية لتشغيلها بدون انترنت من تحميل موارد إضافية من الإعدادات")
