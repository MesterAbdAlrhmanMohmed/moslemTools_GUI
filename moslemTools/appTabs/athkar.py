...
class Athker(qt.QWidget):
    def __init__(self):
        ...
        self.info1 = guiTools.QNavigableLabel("لخيارات فئة الأذكار المحددة، نستخدم مفتاح التطبيقات أو click الأيمن")
        self.info1.setFocusPolicy(qt2.Qt.FocusPolicy.StrongFocus)
        self.info1.setAlignment(qt2.Qt.AlignmentFlag.AlignCenter)
        self.info2 = guiTools.QNavigableLabel("يمكنكم تحميل الأذكار الصوتية لتشغيلها بدون انترنت من تحميل موارد إضافية من الإعدادات")
