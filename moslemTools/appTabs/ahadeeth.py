...
class hadeeth(qt.QWidget):
    def __init__(self):
        ...
        self.info2 = qt.QLineEdit("يمكنكم تحميل المزيد من تحميل موارد إضافية من الإعدادات")
        ...
        self.info1 = qt.QLineEdit("لحذف أي كتاب تم تحميله, نستخدم زر الحذف أو زر التطبيقات أو click الأيمن")
