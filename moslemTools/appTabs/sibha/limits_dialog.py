...
class LimitsDialog(qt.QDialog):
    def __init__(self, parent=None):
        ...
        self.add_btn.setAccessibleDescription("control plus a")
        ...
        self.delete_all_btn.setShortcut("shift+delete")
        self.delete_all_btn.setAccessibleDescription("shift plus delete")
        self.delete_all_btn.clicked.connect(self.delete_all_limits)
        self.set_active_btn = guiTools.QPushButton("تعيين الحد المحدد")
        self.set_active_btn.setStyleSheet("QPushButton {background-color: #0000AA; color: white; min-height: 40px; font-size: 14px; font-weight: bold; border-radius: 4px; padding: 6px 14px;} QPushButton:hover {background-color: #0000CC;}")
        self.set_active_btn.setShortcut("ctrl+g")
        self.set_active_btn.setAccessibleDescription("control plus g")
        ...
        self.delete_btn.setAccessibleDescription("delete")
