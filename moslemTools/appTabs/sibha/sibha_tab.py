...
class sibha(qt.QWidget):
    def __init__(self):
        ...
        self.athkar_laybol = qt.QLabel("قم بتحديد الذكر، لحذف الأذكار نستخدم click الأيمن على قائمة الأذكار هذه.")
        self.athkar_laybol.setAlignment(qt2.Qt.AlignmentFlag.AlignCenter)
        self.athkar = guiTools.QComboBox()
        self.athkar.setAccessibleName("قم بتحديد الذكر")
        self.athkar.setAccessibleDescription("لنطق الذكر المحدد نستخدم الاختصار control plus c  في أي مكان، ولخيارات حذف الأذكار المخصصة نستخدم زر التطبيقات على قائمة الأذكار هذه")
        ...
        self.athkar.addItems(["سُبْحَانَ اللَّهِ", "الْحَمْدُ لِلَّهِ", "لَا إِلَهَ إِلَّا لَّهُ", "اللَّهُ أَكْبَرُ", "رَبِّ اغْفِرْ لِي", "أَسْتَغْفِرُ اللَّهَ", "لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ", "اللَّهُمَّ إِنَّكَ عَفُوٌّ تُحِبُّ الْعَفْوَ فَاعْفُ عَنِّي", "اللَّهُمَّ صَلِّ وَسَلِّمْ وَبَارِكْ عَلَى سَيِّدِنَا مُحَمَّدٍ", "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ سُبْحَانَ اللَّهِ الْعَظِيمِ", "اللَّهُمَّ اغْفِرْ لِي ذَنْبِي كُلَّهُ، دِقَّهُ وَجِلَّهُ، عَلَانِيَتَهُ وَسِرَّهُ، وَأَوَّلَهُ وَآخِرَهُ", "اللَّهُ أَكْبَرُ كَبِيرًا وَالْحَمْدُ لِلَّهِ كَثِيرًا وَسُبْحَانَ اللَّهِ بُكْرَةً وَأَصِيلًا", "سُبْحَانَ اللَّهِ، وَالْحَمْدُ لِلَّهِ، وَلَا إِلَهَ إِلَّا اللَّهُ، وَاللَّهُ أَكْبَرُ، وَلَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ الْعَلِيِّ الْعَظِيمِ", "أَسْتَغْفِرُ اللَّهَ الَّذِي لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ وَأَتُوبُ إِلَيْهِ", "لَا إِلَهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ", "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ عَدَدَ خَلْقِهِ وَرِضَا نَفْسِهِ وَزِنَةَ عَرْشِهِ وَمِدَادَ كَلِمَاتِهِ", "لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ"])
        ...
        self.setStyleSheet("QPushButton#resetButton {background-color: #8B0000; color: white; min-height: 40px; font-size: 16px;} QPushButton#addButton {background-color: rgb(0, 190, 0); color: white; min-height: 40px; font-size: 16px; font-weight: bold; border-radius: 4px;} QPushButton#addButton:hover {background-color: rgb(0, 165, 0);} QPushButton#addButton:pressed {background-color: rgb(0, 140, 0);} QPushButton#minusButton {background-color: #0000AA; color: white; min-height: 40px; font-size: 16px;} QPushButton#limitButton {background-color: #0000AA; color: white; min-height: 40px; font-size: 16px;} QPushButton#limitButton:hover {background-color: #0000CC;} QPushButton#limitButton:pressed {background-color: #000088;} QComboBox, QLineEdit, QSpinBox {min-height: 40px; font-size: 16px;} QLabel {font-size: 16px;}")
    ...
    def reset_count(self):
        ...
        guiTools.speak("تم إعادة التعيين إلى 0")
