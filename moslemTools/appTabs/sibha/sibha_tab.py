...
class sibha(qt.QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("QPushButton#resetButton {background-color: #8B0000; color: white; min-height: 40px; font-size: 16px;} QPushButton#addButton {background-color: #008000; color: white; min-height: 40px; font-size: 16px; font-weight: bold; border-radius: 4px;} QPushButton#addButton:hover {background-color: #006600;} QPushButton#addButton:pressed {background-color: #006600;} QPushButton#minusButton {background-color: #0000AA; color: white; min-height: 40px; font-size: 16px;} QPushButton#limitButton {background-color: #0000AA; color: white; min-height: 40px; font-size: 16px;} QPushButton#limitButton:hover {background-color: #0000CC;} QPushButton#limitButton:pressed {background-color: #000088;} QComboBox, QLineEdit, QSpinBox {min-height: 40px; font-size: 16px;} QLabel {font-size: 16px;}")
