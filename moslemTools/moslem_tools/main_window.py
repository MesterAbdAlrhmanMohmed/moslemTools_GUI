...
class main(AthkarMixin, KhatmahMixin, MessagesMixin, WindowEventsMixin, qt.QMainWindow):
    ...
    (DateConverter(), "محول التاريخ"),
        ...
        about_program_menu = guiTools.QCustomContextMenu("عن البرنامج", self)
        about_program_menu.setFont(font)
        ...
        about_program_menu.addAction(action_whats_new)
        ...
        about_program_menu.addAction(action_release_date)
        self.moreOptionsMenu.addMenu(about_program_menu)
