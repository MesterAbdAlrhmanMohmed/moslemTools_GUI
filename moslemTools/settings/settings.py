...
class settings(qt.QDialog):
    def __init__(self, p):
        ...
        self.defolt = qt.QPushButton("استعادة الإعدادات الإفتراضية")
