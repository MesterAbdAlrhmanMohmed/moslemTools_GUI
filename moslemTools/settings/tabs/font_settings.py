...
class FontSettings(qt.QWidget):
    def __init__(self):
        ...
        self.wrap_checkbox = qt.QCheckBox("وضع التفاف النص (مخصص للمبصرين فقط)")
        self.wrap_checkbox.setAccessibleDescription("هذا الخيار يعرض المحتوة الطويل على أكثر من سطر")
        self.wrap_checkbox.setChecked(settings_handler.get("font", "wrap") == "True")
        self.wrap_checkbox_l = qt.QLabel("هذا الخيار يعرض المحتوة الطويل على أكثر من سطر")
        main_layout.addWidget(self.wrap_checkbox, alignment=qt2.Qt.AlignmentFlag.AlignCenter)
        main_layout.addWidget(self.wrap_checkbox_l, alignment=qt2.Qt.AlignmentFlag.AlignCenter)
        main_layout.addSpacing(10)        
