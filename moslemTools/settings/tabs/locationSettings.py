...
class LocationSettings(qt.QWidget):
    def __init__(self, p):
        ...
        self.dl_app=guiTools.QPushButton("تحميل تطبيق معرفة خطوط الطول ودوائر العرض للأندرويد")
        ...
        self.dl_app1=guiTools.QPushButton("تحميل تطبيق معرفة خطوط الطول ودوائر العرض للios")
