...
class LocationSettings(qt.QWidget):
    def __init__(self, p):
        ...
        coords_layout.setSpacing(20)
        lon_layout = qt.QVBoxLayout()
        lon_layout.setSpacing(4)
        ...
        self.methods = {
            ...
            "16": "الجزائر - وزارة الشؤون الدينية والأوقاف",
            "18": "تونس - وزارة الشؤون الدينية",
            "21": "المغرب - وزارة الأوقاف والشؤون الإسلامية",
            "23": "الأردن - وزارة الأوقاف والشؤون والمقدسات الإسلامية",
            "22": "الأردن - وزارة الأوقاف (المعيار المعدل)",
            ...
            "15": "سلطنة عمان - وزارة الأوقاف والشؤون الدينية",
            "17": "إندونيسيا - وزارة الشؤون الدينية (Kemenag)",
            "19": "ماليزيا - قسم التنمية الإسلامية (JAKIM)",
            "20": "بروناي - وزارة الشؤون الدينية"
        }
        ...
        self.dl_app.setMinimumHeight(40)
        ...
        self.dl_app1.setMinimumHeight(40)
