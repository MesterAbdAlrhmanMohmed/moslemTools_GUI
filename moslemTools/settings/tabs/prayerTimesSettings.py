...
class PrayerTimesSettings(qt.QWidget):
    ...
    def onSoundLevelChanged(self, value):        
        ...
        settings_handler.set("prayerTimes", "volume", str(value))        
    ...
    def onprayerTimesReminderCheckboxStateChanged(self, state):        
        ...
        self.changeAdhanSound.setVisible(state)        
        self.before.setVisible(state)
        self.beforeLabel.setVisible(state)
        self.soundLevelLabel.setVisible(state)
