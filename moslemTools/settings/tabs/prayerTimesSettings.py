...
class PrayerTimesSettings(qt.QWidget):
    def __init__(self, p):
        ...
        self.iqamaVolumeLabel.setVisible(p.cbts(settings_handler.get("prayerTimes", "adaanReminder")))
        ...
        self.iqamaVolumeSlider.setVisible(p.cbts(settings_handler.get("prayerTimes", "adaanReminder")))
        ...
        self.changeIqamaSound.setVisible(p.cbts(settings_handler.get("prayerTimes", "adaanReminder")))
    ...
    def onprayerTimesReminderCheckboxStateChanged(self, state):        
        ...
        self.iqamaVolumeLabel.setVisible(is_checked)
        self.iqamaVolumeSlider.setVisible(is_checked)
        self.changeIqamaSound.setVisible(is_checked)
