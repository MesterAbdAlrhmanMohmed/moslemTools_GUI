...
class Genral(qt.QWidget):
    def __init__(self, p):
        ...
        self.exit_note = guiTools.QNavigableLabel("في حالة إلغاء تحديد المربع أعلاه، سيقوم البرنامج بالإغلاق مباشرة دون عرض نافذة خيارات تشغيل البرنامج.")
        ...
        self.tray_note = guiTools.QNavigableLabel("يمكنكم إظهار أو إخفاء البرنامج عبر استخدام الاختصار windows+alt+h أو من قائمة علبة النظام system tray")
        ...
        self.exit_shortcut_note = guiTools.QNavigableLabel("يمكنكم إيقاف تشغيل البرنامج عبر استخدام الاختصار windows+alt+c")
        self.exit_shortcut_note.setAlignment(qt2.Qt.AlignmentFlag.AlignCenter)
        self.exit_shortcut_note.setFocusPolicy(qt2.Qt.FocusPolicy.StrongFocus)
        main_layout.addWidget(self.exit_shortcut_note)
        main_layout.addSpacing(8)
        self.restart_note = guiTools.QNavigableLabel("يمكنكم إعادة تشغيل البرنامج عبر استخدام الاختصار windows+alt+r")
        self.restart_note.setAlignment(qt2.Qt.AlignmentFlag.AlignCenter)
        self.restart_note.setFocusPolicy(qt2.Qt.FocusPolicy.StrongFocus)
        main_layout.addWidget(self.restart_note)
        main_layout.addSpacing(8)
        self.run_note = guiTools.QNavigableLabel("يمكنكم تشغيل البرنامج من قائمة run بكتابة الأمر (mt) أو الاختصار (ctrl+alt+m)")
