...
class QuranSearchSettings(qt.QWidget):
    def __init__(self):
        ...
        self.tashkeel_checkbox.setChecked(settings_handler.get("quran_search", "ignore_tashkeel") != "False")
        ...
        self.hamza_checkbox.setChecked(settings_handler.get("quran_search", "ignore_hamza") != "False")
        ...
        self.symbols_checkbox.setChecked(settings_handler.get("quran_search", "ignore_symbols") != "False")
