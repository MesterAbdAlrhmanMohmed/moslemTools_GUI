...
class AthkarSettings(qt.QWidget):
    def __init__(self):
        ...
        self.doNotPlayAnythingAtStartup = qt.QCheckBox("عدم تشغيل أي شيئ عند بدء تشغيل البرنامج")
        self.doNotPlayAnythingAtStartup.setChecked(settings_handler.get("athkar", "doNotPlayAnythingAtStartup") == "True")
        self.playAtStartup.clicked.connect(lambda checked: (self.playBasmalaAtStartup.setChecked(False), self.doNotPlayAnythingAtStartup.setChecked(False)) if checked else None)
        self.playBasmalaAtStartup.clicked.connect(lambda checked: (self.playAtStartup.setChecked(False), self.doNotPlayAnythingAtStartup.setChecked(False)) if checked else None)
        self.doNotPlayAnythingAtStartup.clicked.connect(lambda checked: (self.playAtStartup.setChecked(False), self.playBasmalaAtStartup.setChecked(False)) if checked else None)
        group_layout.addWidget(self.playBasmalaAtStartup)
        group_layout.addWidget(self.doNotPlayAnythingAtStartup)
