...
class main(qt.QMainWindow):
    def __init__(self):
        ...
        youtube_action=qt1.QAction("رابط شرح البرنامج على YouTube", self)
        youtube_action.setShortcut("ctrl+shift+y")
        youtube_action.triggered.connect(lambda: webbrowser.open("https://youtu.be/lWqtLWlSYKg?si=mRlPwy-ig-rYh7bj"))
